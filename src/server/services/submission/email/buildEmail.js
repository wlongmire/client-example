...
export async function buildMail(type, toAddress, submission, templateId, pdfArray) {
...
function buildReasonsHTML(submission){
  let reasons;
  if (submission.type === 'oi') {
    submission.oiPremium.reason
  } else {
    submission.ocpPremium.reason
  }
