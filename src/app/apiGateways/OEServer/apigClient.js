...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://ezn98yxd1k.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.apiGetClearanceGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['projectState', 'projectZipcode', 'insuredCity', 'insuredZipcode', 'insuredAddress', 'projectCity', 'insuredState', 'projectAddress'], ['body']);
        ...
        var apiGetClearanceGetRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['projectState', 'projectZipcode', 'insuredCity', 'insuredZipcode', 'insuredAddress', 'projectCity', 'insuredState', 'projectAddress']),
            body: body
        };
    ...
    apigClient.apiGetSubmissionsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);

        var apiGetSubmissionsGetRequest = {
            verb: 'get'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(apiGetSubmissionsGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.umLoginPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);

        var umLoginPostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/um/login').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(umLoginPostRequest, authType, additionalParams, config.apiKey);
    };
