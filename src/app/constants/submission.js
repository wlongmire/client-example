...
export const SUBMISSION_CREATE_FAILED = 'submission/SUBMISSION_CREATE_FAILED'
export const SUBMISSION_CREATE_SUCCESS = 'submission/SUBMISSION_CREATE_SUCCESS'

export const SUBMISSION_EDIT = 'submission/SUBMISSION_EDIT'
export const SUBMISSION_EDIT_FAILED = 'submission/SUBMISSION_EDIT_FAILED'
export const SUBMISSION_EDIT_SUCCESS = 'submission/SUBMISSION_EDIT_SUCCESS'
