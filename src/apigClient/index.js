...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.apiResetcodeCodeGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, ['code'], ['body']);

        var apiResetcodeCodeGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/api/resetcode/{code}').expand(apiGateway.core.utils.parseParametersToObject(params, ['code'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(apiResetcodeCodeGetRequest, authType, additionalParams, config.apiKey);
    };


    apigClient.apiResetcodeCodeDelete = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, ['code'], ['body']);

        var apiResetcodeCodeDeleteRequest = {
            verb: 'delete'.toUpperCase(),
            path: pathComponent + uritemplate('/api/resetcode/{code}').expand(apiGateway.core.utils.parseParametersToObject(params, ['code'])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(apiResetcodeCodeDeleteRequest, authType, additionalParams, config.apiKey);
    };


    apigClient.apiResetcodeCodeOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }

        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);

        var apiResetcodeCodeOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/api/resetcode/{code}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(apiResetcodeCodeOptionsRequest, authType, additionalParams, config.apiKey);
    };
